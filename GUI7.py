...
class ImageBackground(FloatLayout):
    ...
    def yes_button_clicked(self, instance):
        ...
        if not self.yes_button.disabled:
            ...
            Clock.schedule_once(lambda dt: self.show_additional_image_with_animation(temp_image_path), 1)  # Delay the function call





    def show_additional_image_with_animation(self, dt=None):
        ...
        # Animate the image (opacity from 0 to 1) over a duration of 0.5 seconds
