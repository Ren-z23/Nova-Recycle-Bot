    ...
    def video_capture_thread(self):
        ...
        if camera_mode:
            ...
            while True:
                ...
                if ret:
                    frame_path = 'testImage.jpg'
                    cv2.imwrite(frame_path, self.frame)  # Save the frame to a file
                    Clock.schedule_once(lambda dt: self.predict_and_show(frame_path))




    def predict_and_show(self, img):
        predicted_class, probability = self.predicter.predict(img)
